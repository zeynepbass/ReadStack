...
export default function NotesPanel({ notes, draft, onDraftChange, onAdd }) {
  return (
    <div className="flex flex-col gap-3.5">
      ...
      {notes.map((n, i) => (
        <Card key={i} padding="sm" className="flex flex-col gap-1.5">
      ...
      <div className="flex flex-col gap-2">
        <Textarea
          ...
          rows={3}
        />
        <Button size="md" onClick={onAdd} className="self-end">
          Not ekle
        </Button>
      </div>
    </div>
