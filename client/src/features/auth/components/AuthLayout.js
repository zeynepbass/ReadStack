    ...
    <div className="grid min-h-screen grid-cols-[repeat(auto-fit,minmax(min(100%,420px),1fr))]">
      ...
      <div className="flex min-h-[420px] flex-col justify-end gap-8 bg-dark p-[clamp(32px,6vw,80px)] text-cream">
        ...
        <div className="flex gap-8 text-[13px] text-sand">
          <span>
            <b className="font-serif text-xl font-medium text-cream">{formatCount(stats?.booksRead)} kitap</b>
            <br />
            bu ay okundu
          </span>
          <span>
            <b className="font-serif text-xl font-medium text-cream">{formatCount(stats?.pagesRead)} sayfa</b>
            <br />
            bu ay çevrildi
          </span>
        </div>
